import os
import logging
from football_betting_analysis.config import FOOTBALL_DATA_PATH, UNDERSTAT_DATA_PATH, ELO_RATINGS_DATA_PATH, SOCCER_DATA_PATH, TRANSFERMARKT_DATA_PATH
...
os.makedirs(TRANSFERMARKT_DATA_PATH, exist_ok=True)
